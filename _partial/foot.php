...
<!-- Footer Section End -->
            ...
            $sqluser = "SELECT count(status) as total FROM setting where (now() between start and end) and name = 'game'";
                    ...
                    if ($resultuser->num_rows > 0) {
                        ...
                        while($rowuser = $resultuser->fetch_assoc()) { 
                           ...
                           if(isset($_SESSION["userss"])){ 
                            echo '
                            <a href="gamifikasi.php" class="act-btn">
                              <img src="img/box/poin1.gif" width= "300px" height= "270px"></img>
                            </a>';
                           }
                        }
                    }?>
...
<script>
    ...
    function search(){
        ...
        window.location.replace("shop.php?search="+document.getElementById("search-input").value);
