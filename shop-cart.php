                    ...
                    <div class="shop__cart__table">
                        <table>
                            ...
                            <?php
                                ...
                                where dt.email like '".$email."' and dt.status = 0";
                                    ...
                                    while($row = $result->fetch_assoc()) {
                                        ...
                                        <tr>
                                            <td class="cart__product__item">
                                                <img src="admin/images/produk/<?php echo $row['images']; ?>" width="60px" alt="">
                                                <div class="cart__product__item__title">
                                                    <h6><?php echo $row['nama_barang'] ; ?></h6>
                                                </div>
                                            </td>
                                            <td class="cart__price">Rp <?php echo number_format($row['harga']) ; ?></td>
                                            <td class="cart__quantity">
                                                <!-- <div class="pro-qty"> -->
                                                    <?php echo $row['jumlah'] ; ?>
                                                <!-- </div> -->
                                            </td>
                                            <td class="cart__total">Rp <?php echo number_format($row['sub_total']) ; ?></td>
                                            <td class="cart__close"><a href="deldetailtransaksi.php?id=<?php echo $row['id_det_trans'] ?>"><span class="icon_close"></span></a></td>
                                        </tr>
                                <?php    }
                                }else{
                                    echo "0 results";
                ...
                <div class="col-lg-4 offset-lg-2">
                    <div class="cart__total__procced">
                        ...
                        <ul>
                            ...
                            <li>Total <span>Rp <?php echo number_format($total) ?></span></li>
                        </ul>
