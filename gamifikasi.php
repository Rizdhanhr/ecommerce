...
<html>
<head>
    <title>Shoot The Chicken</title>
    <audio hidden autoplay loop>
    <source src="assets/chicken.mp3" type="audio/mpeg">
    </audio>
...
<body>
    <section class="game-container">
        <section class="toolbar">
            <nav>
                <a href id="newgame" >Start</a>
                <!-- <span>|</span> -->
                <!-- <a href id="pausegame" class="disabled">Pause</a>
                <span>|</span>
                <a href id="endgame" class="disabled">End</a>
                <span>|</span>
                <a href id="resetgame" class="disabled">Reset</a> -->
            </nav>
            <section class="score">
        ...
        <section class="play-area">
            <div class="row">
                <div class="item">
                    <div class="up">
                        <img src="assets/ayam.gif" alt="Mole 1" class="mole-img hide">
                    </div>
                    <div class="down">
                        <img src="assets/hole_empty_down.jpg" alt="bottom side of an empty hole 1">
                    </div>
                </div>
                <div class="item">
                    <div class="up">
                        <img src="assets/ayam.gif" alt="Mole 2" class="mole-img hide">
                    </div>
                    <div class="down">
                        <img src="assets/hole_empty_down.jpg" alt="bottom side of an empty hole 2">
                    </div>
                </div>
                <div class="item">
                    <div class="up">
                        <img src="assets/ayam.gif" alt="Mole 3" class="mole-img hide">
                    </div>
                    <div class="down">
                        <img src="assets/hole_empty_down.jpg" alt="bottom side of an empty hole 3">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="item">
                    <div class="up">
                        <img src="assets/ayam.gif" alt="Mole 4" class="mole-img hide">
                    </div>
                    <div class="down">
                        <img src="assets/hole_empty_down.jpg" alt="bottom side of an empty hole 4">
                    </div>
                </div>
                <div class="item">
                    <div class="up">
                        <img src="assets/ayam.gif" alt="Mole 5" class="mole-img hide">
                    </div>
                    <div class="down">
                        <img src="assets/hole_empty_down.jpg" alt="bottom side of an empty hole 5">
                    </div>
                </div>
                <div class="item">
                    <div class="up">
                        <img src="assets/ayam.gif" alt="Mole 6" class="mole-img hide">
                    </div>
                    <div class="down">
                        <img src="assets/hole_empty_down.jpg" alt="bottom side of an empty hole 6">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="item">
                    <div class="up">
                        <img src="assets/ayam.gif" alt="Mole 7" class="mole-img hide">
                    </div>
                    <div class="down">
                        <img src="assets/hole_empty_down.jpg" alt="bottom side of an empty hole 7">
                    </div>
                </div>
                <div class="item">
                    <div class="up">
                        <img src="assets/ayam.gif" alt="Mole 8" class="mole-img hide">
                    </div>
                    <div class="down">
                        <img src="assets/hole_empty_down.jpg" alt="bottom side of an empty hole 8">
                    </div>
                </div>
                <div class="item">
                    <div class="up">
                        <img src="assets/ayam.gif" alt="Mole 9" class="mole-img hide">
                    </div>
                    <div class="down">
                        <img src="assets/hole_empty_down.jpg" alt="bottom side of an empty hole 9">
                    </div>
                </div>
            </div>
        </section>
    ...
    <div class="overlay hide" id="continuegame">
        <h1 class="pauseBlink">Game Paused!</h1>
    </div>
    ...
    <script>
        ...
        function Game() {
            ...
            this.timer = new Timer(this.settings.selectors.timer, this.settings.gameDuration, this.theEnd);
        ...
        Timer.prototype.init = function () {
            ...
            this.timerInterval = setInterval(function () {
                ...
                if (difference > 0) {
                    ...
                    //alert(document.querySelector('#counter').innerText);
                   window.location.href = "insertgamifikasiNew.php?poin=" + document.querySelector('#counter').innerText;
                    scope.stop();
                }
            }, 50);
        }
