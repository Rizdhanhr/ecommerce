...
<body>
        <div class="wrapper">
            <div class="logo"> <img src="admin/dist/img/logo.png" alt=""> </div>
            <div class="text-center mt-4 name"> FIB Collection </div>
            <form class="p-3 mt-3" action="getlogin.php" method="post">
