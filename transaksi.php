                        ...
                        <table>
                            ...
                            <?php
                                ...
                                $sql = "SELECT * FROM db_transaksi 
                                        where email ='".$_SESSION["userss"]."' and status = 1";
                                        ...
                                        <tr>
                                            <td class="cart__product__item">
                                                <div class="cart__product__item__title">
                                                    <h6><?php echo $row['id_transaksi'] ; ?></h6>
                                                </div>
                                            </td>
                                            ...
                                            <td class="cart__quantity">
                                                   <a href="uploadbukti.php?id_transaksi=<?php echo $row['id_transaksi'] ; ?>">Upload Bukti Bayar</a>
