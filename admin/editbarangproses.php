...
$id = mysqli_real_escape_string($conn, $_REQUEST['kodebarang']);
...
$deskripsi = mysqli_real_escape_string($conn, $_REQUEST['keterangan']);
// Ambil Data yang Dikirim dari Form

if($gambar != ""){
  $ekstensi_diperbolehkan = array('jpg','png'); //ekstensi file gambar yang bisa diupload 
  ...
  if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {
    move_uploaded_file($file_tmp, 'images/produk'.$nama_gambar_baru); //memindah file gambar ke folder gambar
     ...
     $sql  = "UPDATE db_barang SET id_barang = '$id', nama_barang = '$namabarang', harga_barang = '$hargabarang',deskripsi = '$deskripsi', images = '$gambar WHERE id_barang = '$id'";
 ...
 //jika file ekstensi tidak jpg dan png maka alert ini yang tampil
    echo "<script>alert('Ekstensi gambar yang boleh hanya jpg atau png.');window.location='editbarang.php?id=$id';</script>";
}
} else {
  // jalankan query UPDATE berdasarkan ID yang produknya kita edit
  $sql  = "UPDATE db_barang SET id_barang = '$id', nama_barang = '$namabarang', harga_barang = '$hargabarang',deskripsi = '$deskripsi', images = '$gambar WHERE id_barang = '$id'";
